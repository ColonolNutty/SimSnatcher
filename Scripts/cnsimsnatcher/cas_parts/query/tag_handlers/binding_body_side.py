...
@SSCASPartQueryRegistry.register_tag_handler(filter_type=SSCASPartTagType.BODY_SIDE)
class SSBindingBodySideTagHandler(SSCASPartTagHandler):
    """ Tags. """

    # noinspection PyMissingOrEmptyDocstring
    def get_tags(self, cas_part: SSBindingCASPart) -> Tuple[Any]:
        return cas_part.body_side,
