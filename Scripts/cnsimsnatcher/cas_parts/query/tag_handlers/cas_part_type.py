...
@SSCASPartQueryRegistry.register_tag_handler(filter_type=SSCASPartTagType.CAS_PART_TYPE)
class SSCASPartTypeTagHandler(SSCASPartTagHandler):
    """ Tags. """

    # noinspection PyMissingOrEmptyDocstring
    def get_tags(self, cas_part: SSCASPart) -> Tuple[Any]:
        return cas_part.part_type,
